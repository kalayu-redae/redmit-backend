            ...
            schemas: {
                ...
                Category: {
                    ...
                    properties: {
                        ...
                        isActive: { type: "boolean" },
                        image: { nullable: true, allOf: [{ $ref: "#/components/schemas/File" }] },
                        createdAt: { type: "string", format: "date-time" },
                    },
                },
                ...
                Order: {
                    ...
                    properties: {
                        ...
                        status: { type: "string", enum: ["PENDING", "CONFIRMED", "PROCESSING", "COMPLETED", "CANCELLED", "REFUNDED"] },
                ...
                Payment: {
                    ...
                    properties: {
                        ...
                        method: { type: "string", enum: ["MANUAL_BANK_TRANSFER", "CHAPA", "STRIPE", "PAYPAL"] },
                        amount: { type: "number" },
                        currency: { type: "string", example: "USD" },
                ...
                Opportunity: {
                    ...
                    properties: {
                        ...
                        type: {
                            type: "string",
                            enum: ["SCHOLARSHIP", "JOB", "INTERNSHIP", "FELLOWSHIP", "COMPETITION", "GRANT", "TRAINING", "VOLUNTEER"],
                        },
                        ...
                        thumbnail: { nullable: true, allOf: [{ $ref: "#/components/schemas/File" }] },
                        createdAt: { type: "string", format: "date-time" },
                        updatedAt: { type: "string", format: "date-time" },
                    },
                },
